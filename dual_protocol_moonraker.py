#!/usr/bin/env python3
"""
Dual Protocol TFT32 Client with Moonraker Integration
Production version that pulls real printer data from Moonraker
"""
...
class DualProtocolTFTMoonraker:
    ...
    async def _send_btt_handshake(self):
        ...
        capabilities = [
            ...
            "Cap:HOST_ACTION_COMMANDS:1", "Cap:PROMPT_SUPPORT:1"
        ]
...
async def main():
    ...
    client = DualProtocolTFTMoonraker(serial_port, baudrate)
